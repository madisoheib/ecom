    ...
    <div class="max-w-4xl mx-auto px-4 py-12">
        ...
        <div id="errorMessage" class="mt-16 max-w-md mx-auto hidden">
            <div class="bg-white rounded-2xl p-6 shadow-lg border-2 border-red-200 text-center">
                ...
                <h3 class="text-lg font-heading text-red-700 mb-2">@t('Order Failed')</h3>
                <p class="text-red-600 mb-4" id="errorText">@t('Please try again or contact support.')</p>
        ...
        <div id="successMessage" class="mt-16 max-w-md mx-auto hidden">
            <div class="bg-white rounded-2xl p-8 shadow-lg border-2 text-center" style="border-color: var(--color-secondary);">
                ...
                <h3 class="text-xl font-heading mb-2" style="color: var(--color-primary);">@t('Order Confirmed!')</h3>
                <p class="text-gray-600 mb-4" id="successText">@t('Your order has been placed successfully.')</p>
                <div class="bg-gray-50 rounded-lg p-4 mb-4">
                    <p class="text-sm text-gray-600 mb-2">@t('Order Number'):</p>
        ...
        <div class="mt-16 max-w-md mx-auto mb-8">
            <div class="bg-gradient-to-r from-green-50 to-blue-50 rounded-2xl p-6 border-2 border-dashed" style="border-color: var(--color-secondary);">
                <div class="text-center">
                    ...
                    <h3 class="text-lg font-heading mb-2" style="color: var(--color-primary);">@t('Register & Save!')</h3>
                    <p class="text-sm text-gray-600 mb-4">@t('Create an account and get') <span class="font-bold" style="color: var(--color-secondary);">{{ $product->registration_discount ?? 5 }}% @t('discount')</span> @t('on this order')</p>
        ...
        <div id="registrationForm" class="max-w-md mx-auto hidden">
            <form id="registerAndOrder" method="POST" action="{{ route('register-order.store') }}" class="space-y-6">
                ...
                <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                    <h3 class="text-lg font-heading mb-4" style="color: var(--color-primary);">@t('Create Account & Order')</h3>
                    ...
                    <!-- Country Detection -->
                    <div class="mb-4">
                        <label class="block text-sm font-subheading text-gray-700 mb-2">@t('Country')</label>
                    ...
                    <div id="citiesDropdown" class="mb-4 {{ !empty($cities) ? '' : 'hidden' }}">
                        <label class="block text-sm font-subheading text-gray-700 mb-2">@t('City')</label>
                    ...
                    <!-- Quantity -->
                    <div class="mb-6">
                        <label class="text-sm font-subheading text-gray-700 mb-2 block">@t('Quantity')</label>
                    ...
                    <div class="border-t border-gray-200 pt-4 mb-6">
                        <div class="space-y-2">
                            ...
                            <div class="flex justify-between items-center text-sm" style="color: var(--color-secondary);">
                                <span>@t('Registration Discount') ({{ $product->registration_discount ?? 5 }}%)</span>
                            ...
                            <div class="flex justify-between items-center text-lg font-bold border-t pt-2">
                                <span class="font-subheading text-gray-700">@t('Total')</span>
...
const translations = {
    ...
    'Account created and order placed successfully!': '@t("Account created and order placed successfully!")', 
    'Product': '@t("Product")',
    'Quantity': '@t("Quantity")',
    'Subtotal': '@t("Subtotal")',
    'Discount': '@t("Discount")',
    'Total': '@t("Total")',
    'You have already registered recently. Please try logging in instead.': '@t("You have already registered recently. Please try logging in instead.")',
    'Please check your information and try again.': '@t("Please check your information and try again.")',
    'A network error occurred. Please check your connection and try again.': '@t("A network error occurred. Please check your connection and try again.")'
};
