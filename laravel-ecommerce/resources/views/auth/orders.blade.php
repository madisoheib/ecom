    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-6xl mx-auto">
            <div class="mb-8">
                ...
                <p class="text-gray-600 mt-2">{{ __('Track and manage your order history') }}</p>
            </div>

            <!-- Orders List -->
            <div class="bg-white rounded-lg shadow-md">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-semibold text-gray-900">{{ __('Order History') }}</h2>
                </div>
                <div class="p-6">
                    <div class="text-center py-12">
                        ...
                        <p class="mt-2 text-sm text-gray-500">{{ __('You haven\'t placed any orders yet. Start shopping to see your orders here.') }}</p>
                        <div class="mt-6">
