<footer style="background-color: var(--color-primary); color: var(--color-secondary);">
    <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- Company Info -->
            <div>
                <div class="flex items-center space-x-2 mb-4">
                    <div class="w-8 h-8 rounded-lg flex items-center justify-center" style="background-color: var(--color-secondary);">
                        <span class="font-roboto-bold text-lg" style="color: var(--color-primary);">R</span>
                    </div>
                ...
                <div class="flex space-x-4">
                    <a href="#" class="text-gray-300 transition-colors" onmouseover="this.style.color='var(--color-secondary)';" onmouseout="this.style.color='';">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="#" class="text-gray-300 transition-colors" onmouseover="this.style.color='var(--color-secondary)';" onmouseout="this.style.color='';">@t('Help Center')</a></li>
                    <li><a href="#" class="text-gray-300 transition-colors" onmouseover="this.style.color='var(--color-secondary)';" onmouseout="this.style.color='';">@t('Shipping Info')</a></li>
                    <li><a href="#" class="text-gray-300 transition-colors" onmouseover="this.style.color='var(--color-secondary)';" onmouseout="this.style.color='';">@t('Returns')</a></li>
                    <li><a href="#" class="text-gray-300 transition-colors" onmouseover="this.style.color='var(--color-secondary)';" onmouseout="this.style.color='';">@t('Track Order')</a></li>
                    <li><a href="#" class="text-gray-300 transition-colors" onmouseover="this.style.color='var(--color-secondary)';" onmouseout="this.style.color='';">@t('Size Guide')</a></li>
                    <li><a href="#" class="text-gray-300 transition-colors" onmouseover="this.style.color='var(--color-secondary)';" onmouseout="this.style.color='';">@t('FAQ')</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="space-y-4">
                    <div class="flex items-start space-x-3">
                        <svg class="w-5 h-5 mt-1" style="color: var(--color-secondary);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                        </svg>
                        <div>
                            <p class="text-gray-300">123 Rue de la Paix</p>
                            <p class="text-gray-300">75001 Paris, France</p>
                        </div>
                    </div>
        ...
        <div class="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="flex space-x-2">
                    <div class="w-8 h-6 rounded flex items-center justify-center" style="background-color: var(--color-secondary);">
                        <span class="text-xs font-roboto-medium" style="color: var(--color-primary);">VISA</span>
                    </div>
                    <div class="w-8 h-6 rounded flex items-center justify-center" style="background-color: var(--color-secondary);">
                        <span class="text-xs font-roboto-medium" style="color: var(--color-primary);">MC</span>
                    </div>
                    <div class="w-8 h-6 rounded flex items-center justify-center" style="background-color: var(--color-secondary);">
                        <span class="text-xs font-roboto-medium" style="color: var(--color-primary);">PP</span>
                    </div>
                </div>
            </div>
        </div>
