        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('categories.index') }}" class="text-gray-300 hover:text-secondary transition-colors">@t('Categories')</a></li>
                    <li><a href="{{ route('brands.index') }}" class="text-gray-300 hover:text-secondary transition-colors">@t('Brands')</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-secondary transition-colors">@t('About Us')</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-secondary transition-colors">@t('Contact')</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="#" class="text-gray-300 hover:text-secondary transition-colors">@t('Returns')</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-secondary transition-colors">@t('Track Order')</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-secondary transition-colors">@t('Size Guide')</a></li>
                    <li><a href="#" class="text-gray-300 hover:text-secondary transition-colors">@t('FAQ')</a></li>
                </ul>
            </div>
